...
/**
 * MT203 - Multiple Financial Institution Transfer mesajı için model sınıfı
 * SWIFT MT203 standardına uygun alanlar içerir
...
public class Mt203 {
    ...
    /**
     * :19: Sum of Amounts
     * Tüm bireysel transferlerin toplamı - MT203 için zorunlu
     * ZORUNLU ALAN
     */
    @NotNull(message = "Sum of Amounts (:19:) MT203 için zorunludur")
     ...
     * Alıcı finansal kurum - MT203 için zorunlu
     */
    ...
    @Builder.Default
    private List<Mt203Transaction> transactions = new ArrayList<>();
    ...
    public BigDecimal calculateTotalAmount() {
        ...
        return transactions.stream()
                ...
                .map(Mt203Transaction::getAmount)
    ...
    public String toSwiftFormat() {
        ...
        if (transactions != null) {
            for (Mt203Transaction transaction : transactions) {
                if (transaction != null) {
